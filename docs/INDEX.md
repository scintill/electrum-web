...
Electrum was created in 2011, during the fallout of an infamous online
wallet heist (MyBitcoin), which was one of the largest Bitcoin thefts
ever recorded. Dr. Thomas Voegtlin, then a computer scientist at INRIA,
set out to help Bitcoin users avoid other such catastrophes by obsoleting
the very environment of centralized server trust.
...
that remains simple and easy to use. With it, you can take full control
over your own money. There's no gadgetry required, and you don't have
to trust anyone.
